...
def console_riddle():
    ...
    for i in range(3, 0, -1):
        ...
        if "time" in user_answer:
            ...
            if i - 1 == 0:
                print("Releasing corrosive agent...\n")
                time.sleep(1)
...
def console_access():
    ...
    time.sleep(1)
    print("What do I do? I have to help my crewmates but is it even posible to save them at this point?!")
...
def user_leaves():
    ...
    time.sleep(1)
    print("** You accidentally kick a piece of scrap metal on the floor, which creates a sound that echoes around the ship. ** \n")
    time.sleep(1)
    print("** You panic even more and run into one of the escape pods. He quickly glance back and see shapes moving into the room. ** ")
    time.sleep(1)
    print("\n** You get into the pod, and sucessfully close it. You start it up and launch off into open space, but then you get suspicious. **")
    time.sleep(1)
...
def combat_system(attack, health, reload):
    ...
    while True:
        ...
        if health <= 25 and flee_chance == 0:
            ...
            print("** Do you wish to keep fighting? (Type yes or no.)**")
            fight_or_flee = input()
